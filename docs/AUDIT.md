...
- **Contre-audit.** Codex a relu la branche le 24 septembre : sept constats (RA-01 à RA-07), aucun
  n'étant une faille du produit démontrée ; tous repris et corrigés le jour même (§4.3). Le harnais
  refait a requalifié la tête les 25 et 26 septembre (§17.4), ce qui clôt RA-01, RA-02 et RA-05.
...
|---|---|---|---|---|---|---|---|
| 1 | Requalifier la tête avec le harnais refait, puis publier (**fait** : §17.4, publié en v0.14.0) | `259056b` a passé 31/31, mais sous la réserve RA-01 et avant RA-02 à RA-05 | une version publiable dont la provenance tient | 2 | 1 | nul | `scripts/validation/hyperv`, `docs/PRODUCTION_READINESS.md`, release |
