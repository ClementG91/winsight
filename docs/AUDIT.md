...
| Suite de tests complète | ~5 min, 3 609 tests (2 976 au début de l'audit), 0 échec | Release, 23 projets |
...
complète (3 609 tests, 0 échec), le build Release (0 avertissement, avertissements traités comme
